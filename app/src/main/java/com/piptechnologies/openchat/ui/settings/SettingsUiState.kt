 ...
 * default-app sheet offers, the recent-numbers count, the version label, and which overlay is open (the
 * default-app sheet, the clear-recents confirmation, or the rating sheet). The Language row's value is
 * not here: the route reads the language in effect where it composes the screen (see [SettingsScreen]).
 */
